...
import static com.honganh.drivers.DriverManager.getDriver;
...
public class MobileUI {
    ...
    public static void clickElementNotWait(WebElement element) {
        System.out.println("[MobileUI] Click element: " + element + " NOT waiting.");
        element.click();
    }
    ...
    public static void setKey(Keys key) {
        System.out.println("[MobileUI] Set key " + key.name());
        Actions actions = new Actions(DriverManager.getDriver());
        actions.sendKeys(key).perform();
        System.out.println("[MobileUI] Set key completed: " + key.name());
    }
    ...
    public static void verifyElementNotDisplayed(WebElement element, String message) {
        System.out.println("[MobileUI] Verifying element is NOT displayed: " + element + ". Message if failed: " + message);
        Assert.assertFalse(isElementPresentAndDisplayed(element), message);
    }
    ...
    public static void verifyElementDisabled(WebElement element, String message) {
        System.out.println("[MobileUI] Verifying element is enabled: " + element + ". Message if failed: " + message);
        Assert.assertFalse(isElementEnabled(element), message);
    }

    public static void verifyElementDisabled(By locator, String message) {
        System.out.println("[MobileUI] Verifying element is enabled: " + locator + ". Message if failed: " + message);
        Assert.assertFalse(isElementEnabled(locator), message);
    }

    public static void verifyElementClickable(WebElement element, String message) {
        System.out.println("[MobileUI] Verifying element is clickable: " + element + ". Message if failed: " + message);
        boolean check = isElementClickable(element);
        System.out.println("Element is clickable: " + check);
        Assert.assertTrue(check, message);
    }

    public static void verifyElementNotClickable(WebElement element, String message) {
        System.out.println("[MobileUI] Verifying element NOT clickable: " + element + ". Message if failed: " + message);
        boolean check = isElementClickable(element);
        System.out.println("Element is clickable: " + check);
